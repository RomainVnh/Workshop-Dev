...
<div class="form-card">
    ...
    <?= $this->Form->control('note', ['label' => 'Petite note (optionnel)', 'placeholder' => 'Ex : perdue au lavage il y a un mois, presque neuve']) ?>

    <?= $this->Form->button('Ajouter à mon tiroir', ['class' => 'btn btn-primary']) ?>
    <?= $this->Form->end() ?>
</div>
